...
For deployment, serve the **repository root** as the static site. `index.html` intentionally lives at repository root; no `dist/` output-directory setting is required.
