...
<header class="shell masthead"><a class="brand" href="../"><img src="../assets/q.svg" width="30" height="30" alt=""><span>QEVA</span></a><nav><a href="./" aria-current="page">Archive</a><a href="../protocol/">Protocol</a><a href="../preservation/">Preservation</a><a href="../institution/">Institution</a></nav></header>
<main class="shell page"><header class="page-header"><p class="eyebrow">ARCHIVE · SEED RELEASE 0.2</p><h1>Inspect the structure.</h1><p>Every entry exposes a plain explanation, exact formulation, context, assumptions, exact revision-pinned dependencies, relations, and the checking actually performed.</p></header>
...
<footer class="shell footer"><span>{len(records)} seed records · Protocol 0.2</span><span><a href="qeva.jsonl">Download archive</a></span></footer><script src="../assets/archive.js"></script></body></html>'''
